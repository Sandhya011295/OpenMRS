...
public class SwagLab1 extends Base_Class{
	@Test(groups = "login")
	...
	private void checkOut() throws InterruptedException {
		...
		driver.findElement(By.xpath("//input[@id=\"first-name\"]")).sendKeys("sandhya");
		driver.findElement(By.xpath("//input[@id=\"last-name\"]")).sendKeys("venkatesh");
		driver.findElement(By.xpath("//input[@id=\"postal-code\"]")).sendKeys("600071");
		Thread.sleep(3000);
